...
export const mathExercises: MathExercise[] = [
  ...
  },
  {
    ...
    hint: "Ajoute d'abord les dizaines.",
  },
  {
    id: "m3",
    category: "calcul",
  ...
  },
  {
    ...
    category: "fractions",
    difficulty: "moyen",
    question: "Calcule 1/2 + 1/4 (sous forme de fraction)",
    answer: "3/4",
  ...
  },
  {
    ...
    category: "problemes",
    difficulty: "facile",
    question: "Léa achète 3 cahiers à 2,50 € l'un. Combien paie-t-elle ?",
    answer: "7.50",
    explanation: "3 × 2,50 € = 7,50 €.",
    hint: "Multiplie le prix par la quantité.",
  },
  {
    id: "m7",
    category: "problemes",
    difficulty: "moyen",
    question: "Un train part à 14h20 et roule 1h45. À quelle heure arrive-t-il ? (format HH:MM)",
    answer: "16:05",
  ...
  },
  {
    ...
    category: "geometrie",
    difficulty: "moyen",
    question: "Périmètre d'un rectangle de longueur 8 cm et largeur 3 cm ? (en cm)",
    answer: "22",
  ...
  },
  {
    ...
    answer: "12",
    explanation: "12 × 12 = 144, donc 144 ÷ 12 = 12.",
    hint: "Cherche : quel nombre × 12 = 144 ?",
  },
];
...
export const readings: Reading[] = [
  {
    ...
    questions: [
      {
        q: "Quelle est la saison dans le texte ?",
        a: "automne",
        hint: "Regarde le premier mot après « forêt ».",
      },
      { q: "Où le renard boit-il ?", a: "rivière", hint: "Relis la deuxième phrase." },
      {
        q: "Que fait l'écureuil ?",
        a: "cacher ses noisettes",
        hint: "Regarde la troisième phrase.",
      },
    ],
    writingPrompt:
      "Raconte en 5 lignes une promenade dans une forêt. Que vois-tu ? Que ressens-tu ?",
  },
  {
    id: "r2",
...
export const sciences: SciFact[] = [
  {
    ...
    content:
      "Les plantes utilisent la lumière du soleil, l'eau et le dioxyde de carbone (CO₂) pour fabriquer leur nourriture (sucre) et rejeter de l'oxygène (O₂).",
    example:
      "C'est comme une petite cuisine dans chaque feuille : soleil + eau + CO₂ → sucre + O₂ que nous respirons.",
    quiz: [
      {
        q: "De quoi la plante a-t-elle besoin ?",
        choices: ["Lumière et eau", "Sable", "Sel"],
        answer: 0,
        explanation: "La plante a besoin de lumière, d'eau et de CO₂.",
      },
      {
        q: "Que rejette la plante ?",
        choices: ["Azote", "Oxygène", "Fumée"],
        answer: 1,
  ...
  },
  {
    ...
    content:
      "L'eau existe sous 3 états : solide (glace), liquide (eau), et gazeux (vapeur). Elle change d'état selon la température.",
    example:
      "Un glaçon (solide) qui fond dans un verre devient liquide, et si on chauffe l'eau, elle s'évapore en vapeur.",
    quiz: [
      {
        q: "Combien d'états a l'eau ?",
        choices: ["2", "3", "4"],
        answer: 1,
        explanation: "Trois : solide, liquide, gazeux.",
      },
      {
        q: "Comment s'appelle le passage liquide → gaz ?",
        choices: ["Fusion", "Évaporation", "Solidification"],
        answer: 1,
  ...
  },
  {
    ...
    content:
      "Dans la nature, les êtres vivants se nourrissent les uns des autres. Les plantes sont mangées par des herbivores, eux-mêmes mangés par des carnivores.",
    example: "Herbe → lapin → renard. Le renard mange le lapin, qui mange l'herbe.",
    quiz: [
      {
        q: "Qui mange les plantes ?",
        choices: ["Carnivores", "Herbivores", "Roches"],
        answer: 1,
...
export const englishLessons: EnglishLesson[] = [
  {
    ...
    quiz: [
      {
        q: "Comment dit-on « J'ai 12 ans » ?",
        choices: ["I have 12 years", "I am 12 years old", "I am 12 year"],
        answer: 1,
      },
      {
        q: "« Ravi de te rencontrer » se dit :",
        choices: ["Nice to meet you", "See you soon", "Good night"],
        answer: 0,
      },
    ],
  },
  {
    ...
    quiz: [
      {
        q: "« Matière préférée » se dit :",
        choices: ["favorite subject", "favorite school", "best matter"],
        answer: 0,
      },
    ],
  },
...
export const subjectMeta: Record<
  Subject,
  { label: string; emoji: string; color: string; route: string }
> = {
