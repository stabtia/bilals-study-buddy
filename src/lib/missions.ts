...
export const missionCatalog: MissionDef[] = [
  {
    id: "d-maths-5",
    period: "daily",
    title: "5 exercices de maths aujourd'hui",
    emoji: "🧮",
    goal: 5,
    xp: 30,
    coins: 15,
  ...
  },
  {
    id: "w-3-subjects",
    period: "weekly",
    title: "Toucher 3 matières différentes",
    emoji: "🎯",
    goal: 3,
    xp: 60,
    coins: 30,
  ...
  },
  {
    id: "w-30min-francais",
    period: "weekly",
    title: "30 min de français cette semaine",
    emoji: "📖",
    goal: 30,
    xp: 70,
    coins: 35,
