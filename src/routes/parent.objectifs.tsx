    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">
          Ajustez l'ambition selon la semaine (vacances, examens...).
        </p>
      </div>

      <form
        onSubmit={save}
        className="bg-white rounded-xl border border-slate-200 p-6 space-y-5 max-w-lg"
      >
        <Field
        ...
        />
        <Field
          label="Niveaux à terminer (indicatif)"
          value={Math.round(min / 30)}
          disabled
          suffix="niveaux"
        />
