  ...
  return (
    <AppLayout>
      <header className="pt-2 pb-4">
        <p className="text-sm font-semibold" style={{ color: "var(--sciences)" }}>🔬 Sciences</p>
      ...
      <article className="card-soft p-6">
        ...
        <div className="mt-4 p-4 rounded-xl text-sm" style={{ background: "color-mix(in oklab, var(--sciences) 15%, white)" }}>
          <b>Exemple du quotidien : </b>{fact.example}
        </div>
      </article>
